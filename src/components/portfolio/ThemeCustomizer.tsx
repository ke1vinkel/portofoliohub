...
export const THEME_PRESETS: PresetTheme[] = [
  {
    id: 'obsidian',
    name: 'Obsidian Dark',
    description: 'Sleek dark theme with vibrant emerald accents and spotlight glows',
    bg_color: '#0d0d11',
  ...
  },
  {
    id: 'neon',
    name: 'Cyber Neon',
    description: 'Deep midnight blue with glowing cyan accents and glassmorphism',
    bg_color: '#05070f',
  ...
  },
  {
    ...
    description: 'Minimalist high-contrast dark palette with monospace typography',
    bg_color: '#18181b',
